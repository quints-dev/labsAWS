...
# 📘 Registro de sesión EC2 – Paolo

**Fecha:** 2025-08-05  
**Instancia EC2:** i-xxxxxxx  
**Base de datos conectada:** Aurora RDS  
**Conexión exitosa:** ✅
...
```bash
script sesion.txt
mysql -u admin -p -h aurora.cluster-xxx.us-west-2.rds.amazonaws.com
SHOW DATABASES;
...
Complete!
sh-4.2$
sh-4.2$ mysql -u admin --password='admin123' -h
mysql: option '-h' requires an argument
sh-4.2$ aurora.cluster-cbxupx0noc8u.us-west-2.rds.amazonaws.com
sh: aurora.cluster-cbxupx0noc8u.us-west-2.rds.amazonaws.com: command not found
sh-4.2$ mysql -u admin - password='admin123' -h aurora.cluster-cbxupx0noc8u.us-west-2.rds.amazonaws.com
...
local-infile FALSE
no-beep FALSE
host aurora.cluster-cbxupx0noc8u.us-west-2.rds.amazonaws.com
html FALSE
xml FALSE
line-numbers TRUE
unbuffered FALSE
...
default-auth (No default value)
binary-mode FALSE
sh-4.2$ mysql -u admin -padmin123 -h aurora.cluster-cbxupx0noc8u.us-west-2.rds.amazonaws.com
